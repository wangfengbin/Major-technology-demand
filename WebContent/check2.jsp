	...
	<form  method="post" id="form2">
		<table width="800" height="550" border="1px"  cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
			...
			<tr>
				...
				<td><input class="inp" type="text" name="name" style="border:0;" value="${needbean.name }"></td>
				<td><strong><font style="color:red">*</font>需求时限<strong></td>
				<td><input class="inp1" type="text" name="qiannian"style="border:0" value="${needbean.qiannian }">年至
					<input class="inp1" type="text" name="hounian"style="border:0" value="${needbean.hounian }">年	
				</td>
			</tr>
			...
			<tr>
				...
				<td colspan="3">
				1.<input type="text" class="inp2" style="border:1px;width:110px" name="guanjian1" value="${needbean.guanjian1 }">
				2.<input type="text" class="inp2" style="border:1px;width:110px" name="guanjian2" value="${needbean.guanjian2 }">
				3.<input type="text" class="inp2" style="border:1px;width:110px" name="guanjian3" value="${needbean.guanjian3 }">
				4.<input type="text" class="inp2" style="border:1px;width:110px" name="guanjian4" value="${needbean.guanjian4 }">
				5.<input type="text" class="inp2" style="border:1px;width:110px" name="guanjian5" value="${needbean.guanjian5 }">
				</td>
			</tr>
			<tr>
				<td><strong>拟投资金额</strong>
				<td colspan="3" ><input class="inp3" type="text" name="money" value="${needbean.money }">万元</td>
			</tr>
			<tr>
			...
			<tr>	
				<td colspan="3">合作意向单位<input class="inp1" type="text" name="depart" value="${needbean.hezuo }">(选填)</td>
			</tr>
			<tr>
			 ...
			 <table id="xueke" style="display:block" width="800"  height="45"  border="1" cellpadding="0" cellspacing="0" style="border-collapse:collapse;"> 
				<tr>
					...
					<td width="350" height="45">
						<input name="firstxueke" style="width:100%;height:100%"  id="firstxueke" value="${needbean.xueke }">
					</td>
					<td id="xueke2" width="350" height="45">
						<input name='twxueke' id='twxueke' style="width:100%;height:100%" value="${needbean.twoxueke }"> 
					</td>
				</tr>
			</table>
			-->
			...
			<table align="center" id="hangye" style="display:none" width="800" height="45"  border="1" cellpadding="0" cellspacing="0" >
			 ...
			 <table width="800" height="45"  border="1" cellpadding="0" cellspacing="0" value="${needbean.twohangye }">
				<tr>
					<td width="125" height="45"><strong>评价</strong></td>
					<td width="700" height="45">
						<textarea rows="5" cols="120" name="ping" style="width:100%;height:100%" ></textarea>
					</td>
					
				</tr>
			</table>
			 
			<input type="submit" value="通过" onclick="form2.action='NeedServlet?method=update&id=${needbean.id }&shenhe=1&pass=wang'">
		<input type="submit" value="不通过" onclick="form2.action='NeedServlet?method=update&id=${needbean.id }&shenhe=2&pass=wang'">
	</form>
	</center>
	</div>
</body>
