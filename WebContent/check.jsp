...
<body style="background-color:#dceefc">
	...
	<form method="post" id="form2">
		<table width="800" height="550" border="1px"  cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
			...
			<input type="submit" value="通过" onclick="form2.action='NeedServlet?method=update&id=${needbean.id }&shenhe=1&pass=xu'">
			<input type="submit" value="不通过" onclick="form2.action='NeedServlet?method=update&id=${needbean.id }&shenhe=2&pass=xu'">
	</form>
	</center>
	</div>
</body>
