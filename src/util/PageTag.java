	...
	public void doTag() throws JspException, IOException {
		...
		if(pagingBean!=null) {
			...
			if(pagingBean.getCurrentPage()>=(pagingBean.getPageCount()-1)) {
				...
				sb.append("<li><a href='").append(pagingBean.getPrefixUrl()).append(pagingBean.isAnd()?"&":"?").append("currentPage=").append(pagingBean.getPageCount()-1).append("' aria-label='Previous'><span aria-hidden='true'> 尾 页</span></a></li>");
			}
			sb.append("<li><a href='#'>");
			sb.append("<span>");
